...
export const Route = createFileRoute("/blog/parking-permits-moving-london")({
  ...
  component: () => (
    ...
    >
      ...
      <p>Most can advise and many will apply on your behalf. We do this regularly for <a href="/house-removals-london">house removals</a>, <a href="/office-removals-london">office moves</a> and <a href="/man-and-van-london">man-and-van</a> jobs — see <a href="/pricing">pricing</a> or <a href="/contact">get in touch</a>.</p>
