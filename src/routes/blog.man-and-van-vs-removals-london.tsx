...
export const Route = createFileRoute("/blog/man-and-van-vs-removals-london")({
  ...
  component: () => (
    ...
    >
      ...
      <p>Man and van is cheaper per hour but slower for bigger jobs. For anything 1-bed and up, full removals usually works out better value once you factor in the time saved. See realistic numbers in our <a href="/blog/cost-of-moving-house-london">cost guide</a>.</p>

      <h2>Conclusion</h2>
      <p>Send a quick inventory and a photo of the trickiest item. A good mover will tell you honestly which service fits — even if it's the cheaper one.</p>
    </BlogPost>
  ),
});
