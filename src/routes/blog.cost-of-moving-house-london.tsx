...
export const Route = createFileRoute("/blog/cost-of-moving-house-london")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Transparent London moving cost ranges by property size, plus what really drives the final price — access, distance, stairs and timing." },
  ...
  component: () => (
    <BlogPost
      ...
      intro="Removal prices in London vary more than most people expect. Two 2-bed flats in the same postcode can cost very different amounts depending on stairs, parking and the items inside. Here's a transparent guide to typical ranges — and what's actually driving the number."
    >
      <div className="not-prose my-6 rounded-lg border border-border bg-muted/40 p-5">
        ...
        <p className="mt-2 text-sm text-foreground">
          Typical ranges for our West London moves fall between <strong>£200 and £900</strong> depending on property size, access and distance. A 1-bed flat sits around £200–£300, a 2-bed £320–£450, and a 3-bed+ home £500–£900. Transparent pricing, no inflated costs — use the estimator below for a closer figure.
        </p>
      </div>

      <h2>Typical Moving Costs in London</h2>
      <p>The table below shows the realistic price bands we see week to week across West London. Bedroom count is a useful starting point; the final figure depends on the factors covered further down the page. Times are typical door-to-door durations, not strict guarantees.</p>
        ...
        <table className="w-full border-collapse text-sm">
          <thead>
            <tr className="border-b border-border bg-muted/40 text-left">
              ...
              <th className="px-3 py-2 font-semibold text-foreground">Typical time</th>
          ...
          <tbody className="text-foreground/90">
            <tr className="border-b border-border">
              ...
              <td className="px-3 py-2">£200–£300</td>
              <td className="px-3 py-2">2–3 hours</td>
              <td className="px-3 py-2">2 movers, Transit or LWB</td>
            </tr>
            <tr className="border-b border-border">
              <td className="px-3 py-2">2-bed flat or small house</td>
              <td className="px-3 py-2">£320–£450</td>
              <td className="px-3 py-2">3–4 hours</td>
              <td className="px-3 py-2">2–3 movers, LWB or Luton</td>
            </tr>
            <tr>
              <td className="px-3 py-2">3-bed+ family home</td>
              <td className="px-3 py-2">£500–£900</td>
              <td className="px-3 py-2">5–7 hours</td>
              <td className="px-3 py-2">3 movers, Luton (often two trips or two vans)</td>
            </tr>
          </tbody>
        </table>
      </div>
      <p>Ranges assume a local move within London with reasonable access. Outside the M25 we quote separately — typically <strong>from £500+ depending on distance</strong>. Top-floor walk-ups or heavy packing requirements push prices toward the upper end of each band. See <a href="/pricing">our pricing page</a> for the full breakdown.</p>
      ...
      <ul>
        ...
        <li><strong>Distance between addresses</strong> — within a borough is the lowest band; cross-London adds van time; outside the M25 is quoted as a longer job.</li>
        <li><strong>Day and time</strong> — Fridays and end-of-month dates book up first and tend to sit at the upper end.</li>
      ...
      <p>Ground-floor to first-floor, lift available, parking on a CPZ at both ends, no packing needed. Two movers, LWB van, around 2–3 hours door-to-door. Indicative range: <strong>£200–£300</strong>.</p>
      <h3>Example 2 — 2-bed Victorian conversion in <a href="/removals-fulham">Fulham</a> to <a href="/removals-chiswick">Chiswick</a></h3>
      <p>Top-floor walk-up (no lift), bay suspension at the loading end, kitchen plus a wardrobe to dismantle, light packing on the morning. Three movers, Luton van, around 3–4 hours. Indicative range: <strong>£360–£450</strong>.</p>
      <h3>Example 3 — 3-bed+ family home in <a href="/removals-richmond">Richmond</a> to <a href="/removals-uxbridge">Uxbridge</a></h3>
      <p>Driveway access at both ends, full house contents including a piano and an American fridge, no packing. Three movers, Luton van, around 5–7 hours including the drive. Indicative range: <strong>£700–£900</strong>.</p>

      <h2>Typical price ranges</h2>
      <p>Typical ranges for our West London moves cover the majority of jobs:</p>
      <ul>
        <li><strong>1-bed flat:</strong> £200–£300 (2–3 hours)</li>
        <li><strong>2-bed flat or small house:</strong> £320–£450 (3–4 hours)</li>
        <li><strong>3-bed+ family home:</strong> £500–£900 (5–7 hours)</li>
      </ul>
      ...
      <p>Within a borough sits at the lower end of the band; across London adds van time. Outside the M25 is quoted separately — from £500+ depending on distance.</p>
      <h3>5. Add-ons</h3>
      ...
      <p>A reputable mover should give you a fixed price after seeing the inventory and access notes — not an "estimate" that grows on the day. That's what we mean by transparent pricing: no inflated costs, no surprises.</p>
      ...
      <p>Mid-month, mid-week moves are easier to slot in and often sit at the lower end of the band. End-of-month and Fridays are the busiest days nationally — book early. For distance: within a borough is usually the lowest band, cross-London adds van time, and any move outside the M25 is quoted as a separate longer job rather than charged hourly.</p>
      ...
      <p>Ask each quote to spell out crew size, van size, and what's included. The lowest line is rarely the best value once the day plays out.</p>
