...
const AREA_GUIDES: Record<AreaSlug, Array<{ href: string; label: string }>> = {
  ealing: [
    ...
    { href: "/blog/cost-of-moving-house-london", label: "what an Ealing move typically costs" },
  ...
  brentford: [
    ...
    { href: "/blog/parking-permits-moving-london", label: "parking permits for riverside access" },
    { href: "/blog/cost-of-moving-house-london", label: "what a Brentford move typically costs" },
  ],
  hounslow: [
  ...
  richmond: [
    { href: "/blog/cost-of-moving-house-london", label: "what a Richmond move typically costs" },
