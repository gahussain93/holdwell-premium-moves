...
const SERVICE_GUIDES: Record<ServiceSlug, Array<{ href: string; label: string }>> = {
  "house-removals-london": [
    { href: "/blog/cost-of-moving-house-london", label: "our London moving cost guide" },
    { href: "/blog/how-long-does-a-house-move-take-london", label: "realistic move-day timings" },
    { href: "/blog/moving-house-checklist-uk", label: "a 4-week UK moving checklist" },
    { href: "/blog/how-to-pack-for-a-house-move-london", label: "room-by-room packing tips" },
  ],
  "office-removals-london": [
    { href: "/blog/office-relocation-guide-london", label: "our office relocation playbook" },
    { href: "/blog/how-long-does-a-house-move-take-london", label: "typical move durations" },
    { href: "/blog/parking-permits-moving-london", label: "permit guidance for moving day" },
  ],
  "business-relocations-london": [
    { href: "/blog/office-relocation-guide-london", label: "planning a low-downtime office move" },
    { href: "/blog/storage-options-when-moving-london", label: "interim storage during a relocation" },
    { href: "/blog/parking-permits-moving-london", label: "bay suspension and access advice" },
  ],
  "small-moves-london": [
    { href: "/blog/moving-a-1-bed-flat-london", label: "what a 1-bed flat move really involves" },
    { href: "/blog/man-and-van-vs-removals-london", label: "choosing between man-and-van and full removals" },
    { href: "/blog/best-time-to-move-house-london", label: "when to book for the best price" },
  ],
  "single-item-transport-london": [
    { href: "/blog/man-and-van-vs-removals-london", label: "when a man-and-van is enough" },
    { href: "/blog/best-time-to-move-house-london", label: "quieter days for cheaper bookings" },
    { href: "/blog/parking-permits-moving-london", label: "kerbside parking and permits" },
  ],
  "man-and-van-london": [
    { href: "/blog/man-and-van-vs-removals-london", label: "man-and-van versus full removals compared" },
    { href: "/blog/moving-a-1-bed-flat-london", label: "moving a small London flat" },
    { href: "/blog/best-time-to-move-house-london", label: "the cheapest days to book" },
  ],
  "packing-assembly-dismantling-london": [
    { href: "/blog/how-to-pack-for-a-house-move-london", label: "a room-by-room packing walkthrough" },
    { href: "/blog/moving-house-checklist-uk", label: "what to do in the weeks before move day" },
    { href: "/blog/cost-of-moving-house-london", label: "typical London moving costs" },
  ],
  "storage-runs-london": [
    { href: "/blog/storage-options-when-moving-london", label: "storage options that fit a move" },
    { href: "/blog/moving-house-checklist-uk", label: "our pre-move checklist" },
    { href: "/blog/cost-of-moving-house-london", label: "what a London move tends to cost" },
  ],
};
